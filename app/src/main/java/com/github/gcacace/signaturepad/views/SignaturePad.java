...
public class SignaturePad extends View {
    ...
    /**
     * Added by Jonathan Perrinet
     */
    private final ArrayList<BezierCurve> beziersCurves = new ArrayList<>();
    ...
    private void addPoint(TimedPoint newPoint) {
        ...
        if (pointsCount > 3) {
            ...
            Log.i("SignaturePad", "Add bezier: " + curve.startPoint.x + " ; " + curve.startPoint.y + " -- "
                    + curve.endPoint.x + " ; " + curve.endPoint.y + " -- "
                    + curve.control1.x + " ; " + curve.control1.y + " -- "
                    + curve.control2.x + " ; " + curve.control2.y);

            Bezier bezier = new Bezier();
            bezier.set(curve.startPoint, curve.control1, curve.control2, curve.endPoint);
    ...
    /**
     * Added by Jonathan Perrinet
     * @return The list of the beziers curves.
     */
    public ArrayList<BezierCurve> getBeziersCurves() {
        return beziersCurves;
    }
