...
public class Bezier {
    ...
    public com.github.gcacace.signaturepad.utils.Bezier set(TimedPoint startPoint, TimedPoint control1,
    ...
    public com.github.gcacace.signaturepad.utils.Bezier clone() {
        com.github.gcacace.signaturepad.utils.Bezier result = new com.github.gcacace.signaturepad.utils.Bezier();
        result.set(startPoint, control1, control2, endPoint);
        return result;
    }
}
